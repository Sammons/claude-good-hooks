 ...
 */
function parseCommandOptions(command: string, args: string[]): { args: string[]; options: Record<string, any> } {
  switch (command) {
    case 'list-hooks':
 ...
 */
function parseListHooksOptions(args: string[]): { args: string[]; options: Record<string, any> } {
  try {
 ...
 */
function parseRemoteOptions(args: string[]): { args: string[]; options: Record<string, any> } {
  try {
    const parsed = parseArgs({
      args,
      options: {
 ...
 */
function parseApplyOptions(args: string[]): { args: string[]; options: Record<string, any> } {
 ...
 */
export function createOptionsWithParent(commandOptions: Record<string, any>, globalOptions: Record<string, any>): any {
  return {
    ...commandOptions,
