...
export class ModuleService {
   ...
   */
  private parseHookIdentifier(hookIdentifier: string): { moduleName: string; exportPath?: string; isFile?: boolean } {
  ...
  extractModuleNameFromHookName(hookName: string): string {
    ...
    while (lastIndex !== -1) {
      ...
      if (possiblePath.endsWith('.js') || possiblePath.endsWith('.mjs') || possiblePath.endsWith('.cjs')) {
        return possiblePath;
      }
    ...
    try {
      ...
      const getPlugin = (mod: any) => {
        ...
        if (mod.default) {
          ...
          if (mod.default.default && typeof mod.default.default === 'object' && 'name' in mod.default.default) {
