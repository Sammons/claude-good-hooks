...
export function getFeatureDescription(feature: string): string {
  switch (feature) {
    case 'react':
      return 'React frontend framework';
    case 'nextjs':
      return 'Next.js React framework';
    case 'vite':
      return 'Vite build tool';
    case 'cra':
    ...
    case 'eslint':
      return 'ESLint code linting';
    case 'prettier':
      return 'Prettier code formatting';
    case 'jest':
      return 'Jest testing framework';
    case 'vitest':
      return 'Vitest testing framework';
    case 'python':
    ...
    case 'pnpm':
      return 'pnpm package manager';
    case 'bun':
      return 'Bun package manager';
    default:
      return feature;
  }
}
